...
import { CheckCircle2, XCircle, ChevronsUpDown, Target } from "lucide-react";
...
const getRatingColor = (rating) => {
  ...
  if (Number.isNaN(numRating)) return "text-gray-600";
        ...
        <Card className="max-w-md mx-auto">
          ...
          <CardContent className="text-center">
            <p className="text-gray-600 mb-6">
              ...
              This could be due to an incomplete interview.
            </p>
            <Button
              variant="outline"
            ...
            <CollapsibleTrigger className="w-full">
              <div className="flex items-center justify-between p-4 bg-gray-100 hover:bg-gray-200 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="font-medium text-gray-800 line-clamp-1 text-left">
                    {item.question}
                  </span>
                </div>
