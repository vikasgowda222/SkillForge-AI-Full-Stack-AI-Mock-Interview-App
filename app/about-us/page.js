  ...
  const tabContent = {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">
            SkillForge AI is on a mission to revolutionize interview preparation
            by providing personalized, intelligent AI coaching tailored to
            individual career aspirations.
          </p>
          <p className="text-base md:text-lg">
            With SkillForge AI, the goal is to bridge the gap between
    ...
    story: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">
            The idea for SkillForge AI AI was born from firsthand experiences
    ...
    approach: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">
            SkillForge AI leverages advanced AI algorithms to generate dynamic,
